...
import SparkleButton from "../ui/SparkelButton";
          ...
          <div>
            ...
            <div className="mt-2 flex gap-2">
              ...
              <SparkleButton
                ...
                className="text-xs font-semibold text-white px-4 py-2 rounded-xl bg-gradient-to-r from-indigo-500 to-blue-500 shadow-sm transition hover:from-indigo-600 hover:to-blue-600 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-300"
              >
                Make unique
              </SparkleButton>
            </div>
