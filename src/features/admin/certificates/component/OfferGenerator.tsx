...
import { jsPDF } from 'jspdf';
  ...
  />
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center gap-3">
                      <div className="w-6 h-6 rounded-full bg-blue-600 text-white flex items-center justify-center font-bold text-[10px]">2</div>
  ...
  />
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center gap-3">
                      <div className="w-6 h-6 rounded-full bg-blue-600 text-white flex items-center justify-center font-bold text-[10px]">3</div>
                      <h3 className="text-sm font-bold text-slate-800">Specific Clauses</h3>
                    </div>
                    <div className="space-y-6 pl-9">
                      <div className="flex justify-between items-center text-[10px] font-bold text-slate-400 uppercase">
                        <span>Probation Period</span>
                        <span className="text-blue-600">{formData.probation} Months</span>
                      </div>
                      <input 
                        type="range" min="1" max="12" value={formData.probation}
  onChange={(e) =>
    setFormData({
      ...formData,
...
>
      ...
      <p className="mt-6 italic text-gray-600">
        {formData.description || "Training details will appear here"}
      </p>

      <div className="mt-10 flex justify-between">
        <div>
          <p className="border-t border-black pt-2">Authorized Signature</p>
        </div>
        <div>
          <p className="border-t border-black pt-2">Company Stamp</p>
        </div>
      </div>
...
//     alert("Certificate Generated (Test Mode)");
//   };
...
//             <span>Internship Generator</span>
//           </div>
//         </div>
//       </header>
...
//                 Probation: {formData.probation} months
//               </p>
//               <input
//                 type="range"
//                 min="1"
...
//               <div id="certificate-preview" className="border p-6 text-center bg-white">
...
//                 <p>
//                   This is to certify that{" "}
//                   <b>{formData.name || "Student Name"}</b>
//                 </p>

//                 <p className="mt-2">
//                   Worked as {formData.jobTitle}
//                 </p>

//                 <p className="mt-2">
//                   From {formData.startDate || "Start Date"} to{" "}
