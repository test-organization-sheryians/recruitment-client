...
type ApplicantsListProps = {
  height?: Size; // number -> px, or string like '60vh'|'520px'
  width?: Size;  // number -> px, or string like '100%'|'820px'
  className?: string;
};
...
export default function ApplicantsList({
  height = 520,     // defaults are applied via parameter destructuring
  width = 840,
  className = "",
}: ApplicantsListProps) {
