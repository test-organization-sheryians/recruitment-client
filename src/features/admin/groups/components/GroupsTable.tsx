...
//         <div className="bg-red-50 border border-red-200 p-6 rounded-2xl text-center max-w-sm">
//           <p className="text-red-600 font-semibold mb-1">Oops! Something went wrong</p>
//           <p className="text-sm text-red-500 mb-4">{fetchError?.message || "Failed to fetch groups"}</p>
//           <button
...
//         <p className="text-sm">Create a group to start managing your candidates.</p>
//       </div>
//     );
//   }
