...
interface SkillCardProps {
  ...
  onUpdate: (payload: { id: string; name: string }) => void;
}

export default function SkillCard({ skill, onDelete, onUpdate }: SkillCardProps) {
  ...
  return (
    <>
      <div className="p-3 bg-white rounded-xl shadow-md transition duration-200 hover:shadow-lg border border-gray-100">
