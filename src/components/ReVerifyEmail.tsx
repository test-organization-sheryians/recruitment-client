// components/ReVerifyEmailPage.tsx
'use client'
      ...
      <div className="w-full max-w-2xl"> 
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 px-10 py-10 text-white text-center">
            ...
            <p className="text-2xl font-bold mt-2 break-all">{userEmail}</p>
          </div>

          {/* Compact Body – Less Height */}
          <div className="px-10 py-10 space-y-8"> {/* Reduced vertical padding */}
